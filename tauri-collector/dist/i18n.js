...
const STRINGS = {
  "en-US": {
    ...
    "auth.okRegistered": "Registered — token filled in, starting…",
    "auth.okLoggedIn": "Signed in — token filled in, starting…",
  ...
  "zh-CN": {
    ...
    "auth.okRegistered": "注册成功,Token 已填好,启动中…",
    "auth.okLoggedIn": "登录成功,Token 已填好,启动中…",
    "update.text": "新版本",
    "update.available": "可用。",
